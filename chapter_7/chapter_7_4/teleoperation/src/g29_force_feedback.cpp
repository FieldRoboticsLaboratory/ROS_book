...
private:
    void targetCallback(const teleoperation::ForceFeedback &in_target);
...
G29ForceFeedback::G29ForceFeedback():
    m_device_name("/dev/input/event6"),
    m_Kp(0.1),
    m_Ki(0.0),
    m_Kd(0.0),
    m_offset(0.01),
...
void G29ForceFeedback::targetCallback(const teleoperation::ForceFeedback &in_target)
{
